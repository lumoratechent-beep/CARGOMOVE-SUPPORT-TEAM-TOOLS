...
const COMPANY_MAPPINGS: MappingItem[] = [
  ...
  { excelCol: 'TYPE', order: 5, dbField: 'company.company_type', formLabel: 'Company Type', dataType: 'String', source: 'Customer Input', notes: 'Forwarder, Haulage, Transporter, or Forwarding Agent.' },
  ...
  { excelCol: 'PORTS', order: 8, dbField: 'company.port_id (resolved)', formLabel: 'Port Terminal', dataType: 'String', source: 'Port Configuration', notes: 'Mapped to backend port ID (e.g. PK-WP-9801a or 5cad3ffb4fe26b4cf4ca563c).' },
  { excelCol: 'DEPOTS', order: 9, dbField: 'company.depot_id (resolved)', formLabel: 'Depot Staging Yard', dataType: 'String', source: 'Port Configuration', notes: 'Mapped to backend depot ID.' },
